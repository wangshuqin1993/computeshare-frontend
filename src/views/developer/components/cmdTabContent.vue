...
.title{
  @apply text-[16px] font-medium text-[#595959] mt-[20px];
}
.title-sub{
  @apply text-[rgba(0,0,0,0.65)] text-[14px] font-medium mt-[10px];
}
.div-bg{
  @apply rounded-[4px] bg-[#FAFBFF] p-[20px] mt-[14px] mb-[20px] text-[14px];
}
</style>